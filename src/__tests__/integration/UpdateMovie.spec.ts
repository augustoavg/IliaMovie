...
describe('Update movie - Integration', () => {
  ...
  it('should not be able to update a movie when it doenst exist', async () => {
    const response = await request(app).put(`/movies/10`).send({});
  ...
  it('should not be able to update a movie when API_KEY is not valid', async () => {
    const movieId = 550;
